...
# Копируем весь остальной исходный код, включая папку static
COPY . .
...
# --- ИСПРАВЛЕНИЕ ЗДЕСЬ ---
# Копируем всю папку static с этапа 'builder' в финальный образ.
# Теперь Go-код сможет найти файл по пути static/index.html
